...
Wordpress Real Time Monitoring.
 
== Description ==
Inspector will inspect your site for speed, security and performance. Your WordPress Theme and Plugins performance data are sent to https://app.inspector.dev where we run analysis.
